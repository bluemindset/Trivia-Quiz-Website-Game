        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item active">
                    <a class="btn btn-primary " >Scores</a>
                </li>
                <li class="nav-item">
...
<div  class="container">
            <h1 style="margin-top: 100px; " class="cover-heading">HALL OF SCORES</h1>
            <h3 class="cover-heading">All Players ordered by Score:</h3>
            <ul class="list-group">
            <?php 
                gather_player();
                foreach($_SESSION["order"] as $name){ 
                    echo "<li>". $name ."</li>";
                }
